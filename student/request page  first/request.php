	...
	<?php
		...
		echo "<table class='table table-bordered table-hover' >";
			...
			while($row=mysqli_fetch_assoc($q))
			{
				echo "<tr>";
				?>
				    <td><input type ="checkbox" name ="check[]" value ="<?php echo $row["book_id"]?>"></td>
				<?php
...
if(isset($_POST['delete']))
{
	if(isset($_POST['check']))
	{
	  ...
	  {
		  mysqli_query($db, "DELETE from issue_book where book_id ='$delete_id' and username ='$SESSION[login_user]' ORDER BY book_id ASC LIMIT 1;");
	  }	
	}
}
?>
