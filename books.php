...
<body>
	<?php
	// $b=mysqli_query($db,"SELECT * FROM 'books' order by bcount desc limit 0,0;");
	 
	 ?>
	<div style="width:100%; height: 50px; margin-top:-20px;">
	  <div style="background-color: red; padding: 10px; width: 10%; height: 50px; float: left;">
	    <h3 style="color: white; margin-top: 0px; ">Trending:</h3>
</div>
<div style="background-color: #ffcccc; width: 90%; heigth: 50px; float: left; padding: 10px;">
<table>
	<?php
	 // while($b2=mysqli_fetch_assoc($b))
	  {
		echo "<tr style='color: black; width: 400px; margin-top: 0px; float: left;'>";
	//	echo "<td>"; echo "[".$b2['book_id']."] &nbsp&nbsp"; echo "</td>";
