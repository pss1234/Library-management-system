...
<body>
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
    ...
    <!---- Admin can add a book , see request , and issue information--->
...
<div id="main">
  ...
  <div class="container" style="text-align: center;">
    ...
    <form class="book" action="" method="post">
        <!-- required page for addmin to add a book--->
...
<?php
    if(isset($_POST['submit']))
    {
      if(isset($_SESSION['login_user']))
      {
        ...
        mysqli_query($db,"INSERT INTO books VALUES ('$_POST[book_id]', '$_POST[name]', '$_POST[authors]', '$_POST[edition]', '$_POST[status]', '$_POST[quantity]', '$_POST[department]','0') ;");
        ?>
        <!--- If book is added than show message that book is added--->
      ...
      {
        ?>
        <!---- for add a book you first login to admin side---->
          <script type="text/javascript">
