...
<div id="main">
  ...
  <div class="container">
    ...
    <form class="Approve" action="" method="post">
        ...
        <input type="text" name="tm" class="form-control" placeholder="Return Date  March 22 ,2022 15:00:00" required="">
...
<?php
  ...
  {
    mysqli_query($db, "INSERT into timer VALUES ('$_SESSION[name]', '$_SESSION[book_id]', '$_POST[tm]') ; ");
    ...
    mysqli_query($db,"UPDATE books SET bcount = bcount+1  where book_id='$_SESSION[book_id]' ;");
