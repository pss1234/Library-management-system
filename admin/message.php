...
<div class="left_box">
  <div class="left_box2">
    <div style="color: #fff;">
    <!-- this is a button where admin choose a student to see his message by the Show button--->
...
<div class="right_box">
  ...
  <!---------show message----------->
     ...
     else
     {
      ...
      {
        ?>
          <img style="margin: 100px 80px; border-radius: 50%;" src="images/p.jpg" alt="animated">
        <?php
      }
      else
      {
        ...
        <div style="height: 70px; width: 100%; text-align: center; color: white; ">
          <h3 style="margin-top: -5px; padding-top: 10px;"> <?php echo $_SESSION['username'] ?> </h3>
            ...
            <?php
              while ($row=mysqli_fetch_assoc($res))
              { 
                //Check who send if student send than 
                if($row['sender']=='student')
                {
            ?>
              <!-------student---------------->
          ...
          <?php
            ...
            // if student not than go for admin page
            else
            {
          ?>
              <!-------admin---------------->
