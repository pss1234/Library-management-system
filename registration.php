...
<section><br><br><br><br>
  <div class ="box">
     <form  name="signup" action="" method="post">
        <b><p style ="padding-left: 50px; font-size: 15px; font-weight: 700;">Sign Up as:</p></b> <!--- sign up button -->
        <!-- from here go to admin side registration page--->
        <input style ="margin-left: 50px; width: 18px;" type="radio" name ="user" id= "admin" value ="admin">
        <label for ="admin">Admin</label>
         <!-- from here go to student side registration page--->
     ...
     {
       // Check condition that user is admin or student if admin than go this page 
       if($_POST['user']=='admin')
     {
       ?>
